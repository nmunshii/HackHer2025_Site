  ...
  return (
    <div className="min-h-screen flex flex-col bg-[url('/background.jpg')] bg-cover bg-center">
        ...
        <div className="w-full h-full px-8 relative">
          ...
          <div className="absolute left-8 top-1/2 -translate-y-1/2">
            <div className="flex gap-6 text-sky-100">
              <button className="hover:text-gray-300 transition-colors font-medium shadow-[0_4px_6px_rgba(0,0,0,0.3)]">
                Home
              </button>
              <button className="hover:text-gray-300 transition-colors font-medium shadow-[0_4px_6px_rgba(0,0,0,0.3)]">
                Upload
          ...
          <div className="absolute right-8 top-1/2 -translate-y-1/2 flex items-center gap-6">
            <button className="text-sky-100 hover:text-gray-300 transition-colors font-medium shadow-[0_4px_6px_rgba(0,0,0,0.3)]">
              Sign Up
            </button>
            <button className="text-sky-100 hover:text-gray-300 transition-colors font-medium shadow-[0_4px_6px_rgba(0,0,0,0.3)]">
              Log In
      ...
      <div className="flex-grow flex flex-col items-center justify-center">
        <div className="w-full max-w-[1480px] mx-auto px-8 flex flex-col items-center">
          <h1 className="text-5xl font-bold tracking-tight text-black mb-8 text-center drop-shadow-[0_4px_3px_rgba(0,0,0,0.3)]">
            Verify your files
          </h1>
          <button className="flex items-center gap-3 bg-purple-600 text-white px-6 py-3 rounded-[15px] hover:bg-purple-700 transition-colors shadow-[0_8px_15px_rgba(0,0,0,0.3)]">
